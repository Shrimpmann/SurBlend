...
async def export_ingredients(
    ...
    # Write header
    writer.writerow([
        'name', 'code', 'type', 'nitrogen', 'phosphate', 'potash',
        'sulfur', 'calcium', 'magnesium', 'cost_per_ton', 'is_available'
    ])
    
    # Write data
    for ing in ingredients:
        writer.writerow([
            ing.name, ing.code, ing.type.value, ing.nitrogen, ing.phosphate,
            ing.potash, ing.sulfur, ing.calcium, ing.magnesium,
            ing.cost_per_ton, ing.is_available
        ])
